contagem_potencial_recursiva_linear = 0
contagem_potencial_recursiva_logaritmica = 0
...
def _potencia_recursiva_linear(base, expoente, resultado=1):
    ...
    :return:
    """
    global contagem_potencial_recursiva_linear
    contagem_potencial_recursiva_linear += 1
...
def _potencia_recursiva_logaritmica(base: int, expoente: int, resultado=1):
    ...
    base ** expoente = se expoente é par: base ** (2 * n), onde n é expoente // 2
                       simplificando (base ** 2) ** n  -> (base * base) ** n
                       Caso contrário expoente = 2 * n + 1    base ** (2*n + 1)
                       base ** (2*n + 1) -> (base ** (2 * n)) = base * [(base * base) ** n]
    ...
    :return:
    """
    global contagem_potencial_recursiva_logaritmica
    contagem_potencial_recursiva_logaritmica += 1
...
if __name__ == '__main__':
    ...
    print(f'*****{contagem_potencial_recursiva_linear} ciclos')
    print(potencia_recursiva_logaritmica(2, 10))
    print(f'*****{contagem_potencial_recursiva_logaritmica} ciclos')
